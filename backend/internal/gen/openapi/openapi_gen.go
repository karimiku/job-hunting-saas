...
func (siw *ServerInterfaceWrapper) DeleteCompanyAlias(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "aliasId", chi.URLParam(r, "aliasId"), &aliasId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteCompany(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "companyId", chi.URLParam(r, "companyId"), &companyId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) ListEntries(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameter("form", true, false, "stageKind", r.URL.Query(), &params.StageKind)
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteInboxClip(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "clipId", chi.URLParam(r, "clipId"), &clipId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
