...
/**
 * 封筒くん — Entré のマスコット。
 * 5表情: happy / cheering / wink / thinking / sleeping
 */
export function Mascot({
  ...
  return (
    ...
    >
      ...
      {/* leaf on top */}
      <path
        d="M45 22 Q50 12 58 18 Q52 24 45 22 Z"
        fill="#9BB58A"
        stroke="#2B2A26"
        strokeWidth="1.5"
      />
      ...
      {mood === "cheering" && (
        <>
          <path
            d="M37 66 L43 70 M43 66 L37 70"
            stroke="#2B2A26"
            strokeWidth="1.6"
            strokeLinecap="round"
          />
          <path
            d="M59 66 L65 70 M65 66 L59 70"
            stroke="#2B2A26"
            strokeWidth="1.6"
            strokeLinecap="round"
          />
          <path
            d="M42 75 Q51 84 60 75"
            stroke="#2B2A26"
            strokeWidth="1.6"
            fill="#fff"
            strokeLinecap="round"
